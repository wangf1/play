package com.wangf.compiler.util;
...
public class CrossReferencer {
	 ...
	 */
	public void print(ISymbolTableStack symTabStack) {
	 ...
	 *            the symbol table.
	 */
	private void printSymTab(ISymbolTable symTab) {
		// Loop over the sorted list of symbol table entries.
		List<ISymbolTableEntry> sorted = symTab.sortedEntries();
		for (ISymbolTableEntry entry : sorted) {
